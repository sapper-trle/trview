...
namespace trview
{
    ...
    ViewOptions::ViewOptions(ui::Control& parent, const ITextureStorage& texture_storage)
    {
        ...
        auto hidden_geometry = std::make_unique<Checkbox>(Point(0, 25), Colour::Transparent, L"Geometry");
        auto water = std::make_unique<Checkbox>(Point(74, 25), Colour::Transparent, L"Water");
        ...
        auto enabled = std::make_unique<Checkbox>(Point(0, 50), Colour::Transparent, L"Depth");
        enabled->on_state_changed += on_depth_enabled;

        auto depth = std::make_unique<NumericUpDown>(Point(74, 50), Size(50, 20), Colour::Transparent, texture_storage.lookup("numeric_up"), texture_storage.lookup("numeric_down"), 0, 20);
        depth->set_value(1);
        ...
        // The TR1-3 method:
        auto tr1_3_panel = std::make_unique<ui::Window>(Point(0, 76), panel_size, Colour::Transparent);
        ...
        // The TR4-5 method:
        auto tr4_5_panel = std::make_unique<ui::Window>(Point(0, 76), panel_size, Colour::Transparent);
