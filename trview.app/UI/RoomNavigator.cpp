...
namespace trview
{
    RoomNavigator::RoomNavigator(ui::Control& parent, const ITextureStorage& texture_storage)
    {
        ...
        auto room_controls = std::make_unique<StackPanel>(Size(140, 30), Colour::Transparent, Size(), StackPanel::Direction::Horizontal);
        ...
        auto listbox = std::make_unique<Listbox>(Point(0, 24), Size(140, 80), Colour::Transparent);
